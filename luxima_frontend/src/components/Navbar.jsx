   ...
   return (
      <>
         ...
         <header
            ...
            style={{
               background: "linear-gradient(90deg, #5D7B93 0%, #8FA3B5 100%)",
            }}
         >
            <div className="container-fluid px-4 d-flex justify-content-between align-items-center">
               ...
               >
                  ...
                  >
                     <span style={{ color: "#5D7B93", fontWeight: "bold" }}>
                        🔍
                     </span>
                  </button>
               </form>
               ...
               <div className="d-flex align-items-center gap-4">
                           ...
                           {cart.length === 0 ? (
                              ...
                              <>
                                 ...
                                 {cart.slice(0, 3).map((item) => (
                                    <li
                                       key={item.id}
                                       className="d-flex justify-content-between px-3 py-2 small border-bottom align-items-center"
                                    >
                                       <div
                                 ...
                                 {cart.length > 3 && (
                                    <li className="text-center py-1 small text-muted">
                                       ...dan {cart.length - 3} barang lainnya
                                    </li>
                                 )}
                                 ...
                                 <li className="d-flex justify-content-between px-3 py-3 small mt-2">
                                    ...
                                    <span className="fw-bold text-success fs-6">
                                       Rp{" "}
                                       {dropdownTotal.toLocaleString("id-ID")}
                                    </span>
                                 </li>
                                 <li>
                                    <Link
                  ...
                  {token ? (
                     ...
                     <div className="d-flex gap-2">
                        ...
                        <span className="text-white opacity-50 align-self-center">
                           |
                        </span>
                        <Link
                           to="/register"
            ...
            <div className="container-fluid px-4">
               <ul className="nav justify-content-center gap-5 fw-bold text-secondary fs-6">
                  <li className="nav-item">
                     <Link
                        to="/"
                        className="nav-link text-dark p-0 hover-underline"
                     >
                        Home
                     </Link>
                  </li>
                  <li className="nav-item">
                     <Link
                        to="/kategori"
                        className="nav-link text-secondary p-0 hover-underline"
                     >
                        Kategori
                     </Link>
                  </li>
                  ...
                  {token && (
                     <li className="nav-item">
                        <Link
                           to="/orders"
                           className="nav-link text-primary p-0 hover-underline"
                        >
                           Pesanan Saya
                        </Link>
                     </li>
