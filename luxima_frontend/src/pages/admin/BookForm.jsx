...
const BookForm = () => {
   ...
   useEffect(() => {
      const fetchDropdowns = async () => {
         try {
            ...
            console.log(err);
            setGlobalError(
               "Gagal memuat data kategori/penulis. Cek koneksi server."
            );
         }
      };
      fetchDropdowns();
   ...
   const handleSubmit = async (e) => {
      ...
      if (formData.is_best_seller) {
         data.append("is_best_seller", "1");
      } else {
         data.append("is_best_seller", "0");
      }
      ...
      try {
         ...
         if (error.response && error.response.status === 422) {
            ...
            if (errorMessages.length > 0) {
               ...
               setGlobalError(
                  error.response.data?.message || "Terdapat kesalahan validasi."
               );
            }
   ...
   // Handler khusus checkbox (karena e.target.value beda dengan checked)
   ...
   return (
      <div className="container-fluid px-4 py-4 bg-light min-vh-100 font-sans">
         ...
         {globalError && (
            <div
               className="alert alert-danger d-flex align-items-center shadow-sm rounded-3 mb-4"
               role="alert"
            >
                     ...
                     <div className="card-body p-4">
                        ...
                        <div className="mb-4">
                           ...
                           <input
                              type="text"
                              name="judul"
                              className={`form-control form-control-lg ${isInvalid(
                                 "judul"
                              )}`}
                        ...
                        <div className="row g-3">
                           ...
                           <div className="col-md-6">
                              ...
                              <input
                                 type="text"
                                 name="isbn"
                                 className={`form-control ${isInvalid("isbn")}`}
                        ...
                        {/* Detail Fisik Buku */}
                        <h6 className="mt-5 mb-3 fw-bold text-primary border-bottom pb-2">
                           Detail Fisik & Spesifikasi
                        </h6>
                        <div className="row g-3">
                           <div className="col-md-6">
                              <label className="form-label fw-semibold text-secondary">
                                 Penerbit <span className="text-danger">*</span>
                              </label>
                              <input
                                 type="text"
                                 name="penerbit"
                           ...
                           <div className="col-md-3">
                              ...
                              <input
                                 type="number"
                                 name="hal"
                                 className={`form-control ${isInvalid("hal")}`}
                                 value={formData.hal}
                                 onChange={handleChange}
                              />
                     ...
                     <div className="card-body text-center p-4">
                        <div className="mb-3 position-relative d-inline-block">
                           {preview ? (
                              ...
                              <div
                                 className="bg-light rounded-3 d-flex flex-column align-items-center justify-content-center border border-dashed"
                                 style={{
                                    width: "100%",
                                    height: "250px",
                                    minWidth: "200px",
                  ...
                  <div className="card shadow-lg border-0 rounded-4">
                     ...
                     <div className="card-body p-4">
                        <div className="mb-3">
                           ...
                           <input
                              type="text"
                              name="no_surat_puskurbuk"
                              className={`form-control ${isInvalid(
                                 "no_surat_puskurbuk"
                              )}`}
                              value={formData.no_surat_puskurbuk}
                              onChange={handleChange}
                           />
                        ...
                        <div className="mb-3">
                           ...
                           <input
                              type="date"
                              name="tgl_surat_keputusan"
                              className={`form-control ${isInvalid(
                                 "tgl_surat_keputusan"
                              )}`}
                              value={formData.tgl_surat_keputusan}
                              onChange={handleChange}
                           />
