   ...
   const categoriesData = [
      {
         ...
         subcategories: [
            ...
            {
               name: "FIKSI ANAK",
               series: ["SERI CERITA ANAK USIA DINI (9 BUKU)", "SERI FABEL BERKARAKTER (10 BUKU)", "SERI AKHLAK ANAK MUSLIM (8 BUKU)", "SERI PENSIL NYATA / PENULIS CILIK (5 BUKU)"],
            },
            {
               name: "AGAMA",
      ...
      },
      {
         ...
         subcategories: [
            {
               name: "AGAMA",
               series: ["SERI BUKU PINTAR ANAK ISLAM (12 BUKU)", "SERI TELADAN ANAK MUSLIM (10 BUKU)", "SERI ADAB ANAK MUSLIM (12 BUKU)", "SERI FIQIH ISLAM PAKET 1 (12 BUKU)", "SERI FIQIH ISLAM PAKET 2 (12 BUKU)"],
            },
            {
               name: "SAINS",
               series: ["SERI SAINS ANAK (15 BUKU)", "SERI DALAM AL-QURAN: KEAJAIBAN LANGIT (15 BUKU)"],
            },
            {
               name: "FIKSI ANAK",
               series: [
            ...
            },
            {
               ...
               series: ["SERI ILMUAN MUSLIM PAKET 1 (10 BUKU)", "SERI ILMUAN MUSLIM PAKET 2 (10 BUKU)"],
            },
            {
               name: "NON FIKSI",
      ...
      },
      {
         ...
         subcategories: [
            {
               name: "PENDIDIKAN",
               series: ["SERI PENGAYAAN GURU USIA DINI (16 BUKU)", "SERI PENGAYAAN GURU PENDIDIKAN INKLUSIF (23 BUKU)"],
            },
         ],
      },
   ];
               ...
               <div className="d-flex align-items-center gap-4">
                  ...
                  {token ? (
                     ...
                     <div className="d-flex gap-2">
                        <Link to="/login" className="btn btn-sm btn-light fw-bold">
                           Login
                        </Link>
                     </div>
                  )}
            ...
            <div className="container-fluid px-4 w-100">
               <ul className="nav justify-content-center gap-5 fw-bold text-secondary fs-6 w-100 m-0 p-0">
                  <li className="nav-item">
                     <Link to="/" className="nav-link text-secondary p-0 hover-underline">
                        Home
                     </Link>
                  </li>
                  <li className="nav-item">
                     <Link to="/kategori" className="nav-link text-dark p-0 hover-underline">
                        Kategori
                     </Link>
                  </li>
                  <li className="nav-item">
                     <span className="nav-link text-secondary p-0 hover-underline" style={{ cursor: "pointer" }}>
                        Best seller
                     </span>
                  </li>
                  <li className="nav-item">
                     <Link to="/about" className="nav-link text-secondary p-0 hover-underline">
                        About Us
                     </Link>
                  </li>
               </ul>
               ...
               {categoriesData.map((cat) => (
                  <div key={cat.id} className="col-md-4">
                     ...
                     >
                        ...
                        <span style={{ fontSize: "24px", opacity: 0.5 }}>{activeCategory.id === cat.id ? "▼" : "▶"}</span>
               ...
               <div className="card border-0 shadow-sm w-100" style={{ minHeight: "200px" }}>
                        ...
                        <div className="row g-3 w-100 mx-0">
                           {activeSub.series.map((seri, idx) => (
                              ...
                              <div key={idx} className="col-md-6 col-lg-3">
                                 <div className="p-3 border rounded d-flex align-items-center gap-3 hover-effect h-100" style={{ cursor: "pointer", backgroundColor: "#fff", transition: "0.2s" }}>
                                    <div
                  ...
                  <div class="album py-5 bg-light">
                     {books.length > 0 ? (
                                            ...
                                            <div key={book.id} className="col d-flex">
                                                <div className="card shadow-sm w-100">
                                                    ...
                                                    <div className="card-body d-flex flex-column">
                                                        <h5 className="card-title fw-bold text-dark fs-6 mb-1">{book.judul}</h5>
                                                        <p className="card-text small text-muted mb-3 flex-grow-1">
                                                            Deskripsi singkat buku. Konten ini untuk mengisi bagian utama kartu.
                                                        </p>
                                                        
                                                        <div className="d-flex justify-content-between align-items-center mb-3 pt-2 border-top">
                                                            <h5 className="card-title fw-bolder text-danger fs-5 m-0">Rp. {book.harga}</h5>
                                                        </div>
                                                        <div className="d-grid gap-2">
                                                            <Link to="#" className="btn btn-outline-dark btn-sm fw-bold">
                                                                Lihat Detail
                                                            </Link>
                                                            <Link to="#" className="btn btn-primary btn-sm fw-bold">
                                                                Tambah Keranjang
                                                            </Link>
                                                        </div>
                                                    </div>
                                    ...
                                    <p className="text-center text-muted">Data Buku Kosong</p>
                                )}
                  </div>
               </div>
            </div>
            ...
            <div className="container-fluid px-4 w-100">
               <div className="row g-4">
                  <div className="col-md-4">
                     ...
                     <p className="small text-secondary lh-lg">Toko buku online terlengkap dengan pengalaman belanja yang nyaman dan menyenangkan.</p>
                  </div>
                  <div className="col-md-4">
