    ...
    >
      ...
      <div className="container-fluid px-4 my-5">
        ...
        <section className="py-4">
          <div className="row align-items-center">
            <div className="col-md-6 ps-lg-5">
              <h6 className="text-uppercase text-muted ls-1 small fw-bold">
                Books on Wellbeing
              </h6>
              <h1 className="display-4 fw-bold mb-3 text-dark">
                Temukan kisah inspiratif dalam novel "Langit Senja".
              </h1>
              <p className="text-secondary mb-4 fs-5">
                Perjalanan cinta dan harapan yang lahir di balik luka masa lalu.
              </p>
              <button
                className="btn text-white px-5 py-2 shadow-sm rounded-pill"
                style={{ backgroundColor: "#5D7B93" }}
              >
                Show all
              </button>
            ...
            <div
              className="col-md-6 position-relative d-flex justify-content-center mt-5 mt-md-0"
        ...
        <div className="d-flex justify-content-between align-items-end mb-4 px-lg-2">
          ...
          <Link
            to="/kategori"
            className="text-muted small text-decoration-none fw-bold"
          >
            View more &gt;
          </Link>
        </div>
            ...
            <>
              <div className="col-md-6 col-lg-3">
                <div
                  ...
                  style={{ height: "200px", backgroundColor: "#D90429" }}
                ></div>
              </div>
              <div className="col-md-6 col-lg-3">
                <div
                  className="rounded shadow-sm"
                  style={{ height: "200px", backgroundColor: "#FFC09F" }}
                ></div>
              </div>
              <div className="col-md-6 col-lg-3">
                <div
                  className="rounded shadow-sm"
                  style={{ height: "200px", backgroundColor: "#2D6A4F" }}
                ></div>
              </div>
              <div className="col-md-6 col-lg-3">
                <div
              ...
              >
                <div className="card h-100 border-0 bg-transparent hover-lift">
                  ...
                  >
                    ...
                    {book.cover_buku && (
                      <span
                        className="fs-1 opacity-50 position-absolute"
                        style={{ display: "none" }}
                      >
                        📖
                      </span>
                  ...
                  <div className="card-body p-0">
                    <div
                      className="text-muted small mb-1 text-uppercase fw-bold"
                    ...
                    <div className="d-flex justify-content-between align-items-center border-top pt-2">
                      <span className="fw-bold text-dark">
                        ...
                        Rp{" "}
                        {book.harga
                          ? Number(book.harga).toLocaleString("id-ID")
                          : "0"}
                      </span>
                      <button
          ...
          <div className="row g-4">
            <div className="col-md-4">
              ...
              <p className="small text-secondary lh-lg">
                Toko buku online terlengkap dengan pengalaman belanja yang
                nyaman.
              </p>
            </div>
            <div className="col-md-4">
              ...
              <ul className="list-unstyled small text-secondary lh-lg">
                <li>
                  🏠 Jl. Jaha Gg. Mujahidin No.25, RT.9/RW.1, Kalisari, Kec. Ps.
                  Rebo, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13790
                </li>
